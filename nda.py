...
def logo():
        ...
        print(R,':' ')
        print(R,' ')
        print(R,' ',G,'Author  : RIAZ'+R+'_'+G+'Min')
        print(R,' ',G,'Github  : Riazkiller ',k)
...
def about():
    ...
    print('Version                3.0')
    print('Special thanks to     '+G+' RIAZKHAN'+k+' and'+G+' DANISH KHAN'+k)
    ...
    print('YOUTUBE               https://youtube.com/channel/UCPOWtzNan9ff-E0RI66Wu2A')
    print('WhatsApp               +923188214452')
    print('Date                   01:15 01-01-2021')
    print('FROM                PAKISTAN LOVE YOY PAK ARMY')
